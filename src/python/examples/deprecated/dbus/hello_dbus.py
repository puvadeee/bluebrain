...
#hci = bus.get_object('org.bluez',   '/org/bluez/hci0')
#hci_adp_iface = dbus.Interface(hci,  dbus_interface='org.bluez.Adapter1')
#props = hci_adp_iface.getProperties()
#print props
...
dbus-send --system --print-reply  --dest=org.bluez   /org/bluez/hci0/dev_D6_8C_8C_A5_36_B2   org.freedesktop.DBus.Properties.GetAll    string:"org.bluez.Device1"
...
Not working
dbus-send --system --print-reply  --dest=org.bluez   /org/bluez/hci0/dev_D6_8C_8C_A5_36_B2/7e400001b5a3f393e0a9e50e24dcca9e   org.freedesktop.DBus.Properties.GetAll    string:"org.bluez.GattService1"
7e400001-b5a3-f393-e0a9-e50e24dcca9e

from: https://git.kernel.org/cgit/bluetooth/bluez.git/tree/doc
