...
public class RFduinoService extends Service {
    ...
    public final static UUID UUID_SEND_LONG = BluetoothHelper.longUuid(0x0003);
    public final static UUID UUID_DISCONNECT_LONG = BluetoothHelper.longUuid(0x0004);
    public final static UUID UUID_CLIENT_CONFIGURATION_LONG = BluetoothHelper.longUuid(0x2902);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                mBluetoothGattService = gatt.getService(UUID_SERVICE_LONG);
                ...
                BluetoothGattCharacteristic receiveCharacteristic =
                        mBluetoothGattService.getCharacteristic(UUID_RECEIVE_LONG);
    ...
    public boolean send(byte[] data) {
        ...
        BluetoothGattCharacteristic characteristic =
                mBluetoothGattService.getCharacteristic(UUID_SEND_LONG);
